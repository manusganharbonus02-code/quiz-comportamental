  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 text-center py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto mt-16 w-full">
          <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-700/50 transition-all duration-300 hover:border-amber-500/50 hover:bg-slate-800/50 hover:scale-105">
